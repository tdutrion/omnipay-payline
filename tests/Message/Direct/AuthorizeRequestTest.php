...
class AuthorizeRequestTest extends MessageTestCase
{
    ...
    public function testData()
    {
        ...
        $this->assertEquals($customer->getTitle(), $data['buyer']['title']);
        $this->assertEquals($customer->getFirstName(), $data['buyer']['firstName']);
        $this->assertEquals($customer->getLastName(), $data['buyer']['lastName']);
        $this->assertEquals($customer->getEmail(), $data['buyer']['email']);
        ...
        $this->assertSame($card->getBillingCustomer()->getPhoneExtension(), $data['buyer']['billingAddress']['phoneType']);
